module Ghiv
  module Config
    class << self
      require 'yaml'
      attr_accessor :in_stream, :password, :out_stream, :query_creator, :query_direction, :query_labels, :query_milestone, :query_number, :query_sort, :query_state, :raw, :repository, :user
